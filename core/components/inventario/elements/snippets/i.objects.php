...
$select = array(
	'InventarioItems' => $modx->getSelectColumns('InventarioItems', 'InventarioItems')
);
...
if ($_REQUEST['pageId']) {
	if ($_SESSION['i_filters'][$_REQUEST['spage'] . '_' . $scriptProperties['col_id']]) {
		$scriptProperties['where'] = $_SESSION['i_filters'][$_REQUEST['spage'] . '_' . $scriptProperties['col_id']];
	}
}
...
$default = array(
	'class' => 'InventarioItems',
	'where' => $where,
	'select' => $select,
	'sortby' => 'InventarioItems.id',
	'sortdir' => 'ASC',
